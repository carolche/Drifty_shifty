...
#
# [] = focusstacking(input_dir, output_dir, output_format, parallel=True)
#
...
# EXAMPLE USAGE
#
# 1. focusstacking(input_dir, output_dir, output_format='png')
...
# run in parallel.
#
# 2. focusstacking(input_dir, output_dir, output_format='png', image_range=(5,200)
...
def focusstacking(input_dir, output_dir_fs, output_format, parallel=True, image_range_fs=True, overwrite=True):
...
if __name__ == "__main__":
    ...
    # call the function
    focusstacking(input_dir, output_dir_fs, output_format, parallel=True, image_range_fs=True, overwrite=True)
